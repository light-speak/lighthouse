...
func (i *IDScalar) ParseValue(value string) (interface{}, error) {
...
func (i *IDScalar) Serialize(value interface{}) (string, error) {
...
func (i *IDScalar) ParseLiteral(value ast.Value) (interface{}, error) {
	switch v := value.(type) {
	case *ast.IntValue:
		return v.Value, nil
	default:
