...
type UserLoaderConfig struct {
	...
	Fetch func(keys []int64) ([]*models.User, []error)
...
func (l *UserLoader) Load(key int64) (*models.User, error) {
...
func (l *UserLoader) LoadThunk(key int64) func() (*models.User, error) {
	l.mu.Lock()
...
func (l *UserLoader) LoadAll(keys []int64) ([]*models.User, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *UserLoader) LoadAllThunk(keys []int64) func() ([]*models.User, []error) {
	results := make([]func() (*models.User, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
