...
type ComplexityRoot struct {
	...
	Mutation struct {
		...
		UpdateUser func(childComplexity int, id int64, name string, email string) int
	}
...
type MutationResolver interface {
	...
	UpdateUser(ctx context.Context, id int64, name string, email string) (*models.User, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.updateUser":
		...
		return e.complexity.Mutation.UpdateUser(childComplexity, args["id"].(int64), args["name"].(string), args["email"].(string)), true
...
`, BuiltIn: false},
	{Name: "../schema/user.graphqls", Input: `type User implements BaseModelSoftDelete @key(fields: "id") {
    id: ID!
    createdAt: Time!
    updatedAt: Time!
    deletedAt: Time
...
func (ec *executionContext) _Entity_findUserByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNUser2ᚖuserᚋgraphᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_createUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be *models.User/graph.User`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*models.User)
	fc.Result = res
	return ec.marshalOUser2ᚖuserᚋgraphᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_updateUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		directive0 := func(rctx context.Context) (interface{}, error) {
			ctx = rctx // use context from middleware stack in children
			return ec.resolvers.Mutation().UpdateUser(rctx, fc.Args["id"].(int64), fc.Args["name"].(string), fc.Args["email"].(string))
		}

		directive1 := func(ctx context.Context) (interface{}, error) {
			if ec.directives.Update == nil {
				var zeroVal *models.User
				return zeroVal, errors.New("directive update is not implemented")
			}
			return ec.directives.Update(ctx, nil, directive0)
		}
...
var userImplementors = []string{"User", "BaseModelSoftDelete", "_Entity"}
...
func (ec *executionContext) marshalNUser2userᚋgraphᚐUser(ctx context.Context, sel ast.SelectionSet, v models.User) graphql.Marshaler {
	return ec._User(ctx, sel, &v)
}

func (ec *executionContext) marshalNUser2ᚖuserᚋgraphᚐUser(ctx context.Context, sel ast.SelectionSet, v *models.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOUser2ᚖuserᚋgraphᚐUser(ctx context.Context, sel ast.SelectionSet, v *models.User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._User(ctx, sel, v)
