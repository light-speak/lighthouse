...
//go:embed "lighthouse.graphqls" "user.graphql"
...
var sources = []*ast.Source{
	{Name: "lighthouse.graphqls", Input: sourceData("lighthouse.graphqls"), BuiltIn: false},
...
func (ec *executionContext) _Entity_findUserByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*User)
	fc.Result = res
	return ec.marshalNUser2ᚖexampleᚋgraphᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_user(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be *example/graph.User`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*User)
	fc.Result = res
	return ec.marshalOUser2ᚖexampleᚋgraphᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _BaseModel(ctx context.Context, sel ast.SelectionSet, obj BaseModel) graphql.Marshaler {
	switch obj := (obj).(type) {
	case nil:
		return graphql.Null
	default:
...
func (ec *executionContext) _BaseModelSoftDelete(ctx context.Context, sel ast.SelectionSet, obj BaseModelSoftDelete) graphql.Marshaler {
	switch obj := (obj).(type) {
	case nil:
		return graphql.Null
	case User:
...
func (ec *executionContext) marshalNUser2exampleᚋgraphᚐUser(ctx context.Context, sel ast.SelectionSet, v User) graphql.Marshaler {
	return ec._User(ctx, sel, &v)
}

func (ec *executionContext) marshalNUser2ᚖexampleᚋgraphᚐUser(ctx context.Context, sel ast.SelectionSet, v *User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOUser2ᚖexampleᚋgraphᚐUser(ctx context.Context, sel ast.SelectionSet, v *User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._User(ctx, sel, v)
